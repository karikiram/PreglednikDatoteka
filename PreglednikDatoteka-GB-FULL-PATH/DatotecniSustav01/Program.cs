...
namespace DatotecniSustav01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("+------------------+-------------+---------+------------------------------------------+");
            Console.WriteLine("| Veličina       B |          KB |              MB |              GB |                TB | {0, 20} |",nazivi);
            Console.WriteLine("+------------------+-------------+---------+------------------------------------------+");
            foreach (FileInfo d in datoteke)
            {
                string directoryFullPath = Path.GetFullPath(d.FullName);
                velicina += d.Length;
                Console.WriteLine("|{0, 15} B | {1, 8} KB | {2, 8} MB     | {3, 8} GB     | {4, 8} TB       | {5,20} |",
                    d.Length,
                    d.Length / 1024,
                    d.Length / (1024 * 1024),
            ...
            Console.WriteLine("+------------------+-------------+---------+------------------------------------------+");
            Console.WriteLine("|{0, 15} B | {1, 8} KB | {2, 8} MB     | {3, 8} GB     | {4, 8} TB       |                      |",
            ...
            while (true)
            {
                ...
                if (Console.KeyAvailable)
                {
                    ...
                    if (pritisnutaTipka3.Key == ConsoleKey.UpArrow)
                    {
                        Console.SetCursorPosition(1, pokazivacY);
                        Console.Write(" ");
                        pokazivacY--;
                ...
                if (Console.KeyAvailable)
                {
                    ...
                    if (pritisnutaTipka2.Key == ConsoleKey.D)
                    {
